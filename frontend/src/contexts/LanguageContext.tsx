...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'editor.title': 'Smart Assistant Editor',
    'editor.issues_found': 'Issues found',
    'editor.show_all': 'Show All',
    'editor.show_issues_only': 'Issues Only',
    'editor.save': 'Save & Reanalyze',
    'editor.assistant': 'AI Assistant',
    'editor.issue': 'Issue',
    'editor.line': 'Line',
    'editor.severity': 'Severity',
    'editor.matched_words': 'Matched words',
    'editor.context': 'Context',
    'editor.mark_false_positive': 'Mark as False',
    'editor.jump_to_line': 'Jump to Line',
    'editor.no_issues': 'No issues found!',
    'editor.script_clean': 'Your script looks clean.',
    'editor.open': 'Smart Editor',
  },
  ru: {
    ...
    'editor.title': 'Умный Ассистент-Редактор',
    'editor.issues_found': 'Найдено проблем',
    'editor.show_all': 'Показать всё',
    'editor.show_issues_only': 'Только проблемы',
    'editor.save': 'Сохранить и переанализировать',
    'editor.assistant': 'AI Ассистент',
    'editor.issue': 'Проблема',
    'editor.line': 'Строка',
    'editor.severity': 'Серьёзность',
    'editor.matched_words': 'Найденные слова',
    'editor.context': 'Контекст',
    'editor.mark_false_positive': 'Отметить как ложное',
    'editor.jump_to_line': 'Перейти к строке',
    'editor.no_issues': 'Проблем не найдено!',
    'editor.script_clean': 'Ваш сценарий выглядит чистым.',
    'editor.open': 'Умный редактор',
  },
}
