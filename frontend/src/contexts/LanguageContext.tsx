...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'script.file_format': 'TXT and DOCX files',
    ...
    'parents_guide.title': 'Parents Guide',
    'parents_guide.episodes': 'Episodes',
    'parents_guide.coverage': 'Coverage',
    'parents_guide.peak_matches': 'Peak Matches',
    'parents_guide.severe_warning': 'This category contains significant content that may not be suitable for younger audiences.',
    'parents_guide.rating_guide_title': 'Rating Guide:',
    'parents_guide.severity_none': 'No content concerns',
    'parents_guide.severity_mild': 'Minor content, suitable for most audiences',
    'parents_guide.severity_moderate': 'Some content may not be suitable for children',
    'parents_guide.severity_severe': 'Significant content requiring parental discretion',
    'severity.NONE': 'NONE',
    'severity.MILD': 'MILD',
  ...
  ru: {
    ...
    'script.file_format': 'TXT и DOCX файлы',
    ...
    'parents_guide.title': 'Руководство для родителей',
    'parents_guide.episodes': 'Эпизоды',
    'parents_guide.coverage': 'Покрытие',
    'parents_guide.peak_matches': 'Пик совпадений',
    'parents_guide.severe_warning': 'Эта категория содержит значительный контент, который может не подходить для младшей аудитории.',
    'parents_guide.rating_guide_title': 'Руководство по рейтингам:',
    'parents_guide.severity_none': 'Нет проблемного контента',
    'parents_guide.severity_mild': 'Незначительный контент, подходит для большинства',
    'parents_guide.severity_moderate': 'Некоторый контент может не подходить для детей',
    'parents_guide.severity_severe': 'Значительный контент, требующий родительского контроля',
    'severity.NONE': 'НЕТ',
